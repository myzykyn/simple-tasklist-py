...
class TodoApp:
    ...
    def create_widgets(self):
        ...
        # Title
        title_label = ctk.CTkLabel(self.main_frame, text="Minimalist 📝", font=("Helvetica", 24, "bold"), text_color=text_color)
        ...
        self.theme_switch = ctk.CTkSwitch(
            ...
            text="Modo oscuro",
            command=self.toggle_color_appereance,
            onvalue="Dark",
            offvalue="Light"
        )
        ...
        self.task_input = ctk.CTkEntry(input_frame, placeholder_text="Enter a task", 
                                    fg_color=bg_color, text_color=text_color, placeholder_text_color="#6C6C7C",
    ...
    def toggle_color_appereance(self):
